        ...
        public void imageSave()
        {
            ...
            try
            {
                ...
                if (imagename != "")
                {
                    ...
                    query = "insert into BOOKS(BOOK_ID,BOOK_TITLE,BOOK_PAGES,BOOK_CATEGORY,BOOK_POSITION,BOOK_PRICE,AUTHOR_ID, BOOK_COMMENT,BOOK_PHOTO) values(" + textBox1.Text + "," + "'" + textBox2.Text + "'," + "'" + textBox3.Text + "'," + "'" + textBox4.Text + "'," + "'" + textBox5.Text + "'," + "'" + textBox6.Text + "'," + "'" + textBox7.Text + "'," + "'" + textBox8.Text + "'," + " :BlobParameter )";
