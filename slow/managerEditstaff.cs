...
{ 
    ...
    public partial class managerEditstaff : Form
    {
        ...
        public void imageSave()
        {
            ...
            try
            {
                ...
                if (imagename != "")
                {
                    ...
                    query = "insert into staff(STAFF_ID,STAFF_FIRSTNAME,STAFF_LASTNAME,STAFF_USER,STAFF_PASSWORD,STAFF_PHOTO) values(" + textBox1.Text + "," + "'" + textBox2.Text + "'," + "'" + textBox3.Text + "'," + "'" + textBox4.Text + "'," + "'" + textBox5.Text + "'," + " :BlobParameter )";
        ...
        public managerEditstaff()
        {
            InitializeComponent();
        }

        private void managerEditstaff_Load(object sender, EventArgs e)
        {
